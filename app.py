...
X_input[feature_columns] = scaler.transform(X_input[feature_columns])
X_input = X_input[feature_columns]  # Ensure order matches training
...
if st.button("🔮 Predict Attrition Risk"):
    try:
        ...
        st.error("An error occurred while making the prediction. Please check your model and inputs.")
        st.exception(e)

# Footer
st.markdown("---")
st.caption("Model powered by Logistic Regression on balanced features using SMOTE.")
